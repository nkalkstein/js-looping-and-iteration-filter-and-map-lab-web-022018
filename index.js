...
function exactMatch(array, driverObject) {
    return array.filter(driver => driver[Object.keys(driverObject)[0]] === Object.values(driverObject)[0])
}
...
function exactMatchToList(array, driverObject) {
  return exactMatch(array, driverObject).map( driver => driver.name)
